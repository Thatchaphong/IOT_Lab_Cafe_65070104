...
export default function StudentByIdPage() {
  const { studentId } = useParams();

  const { data: student, isLoading, error } = useSWR<Student>(`/students/${studentId}`);
        ...
        <Container className="mt-4">
          ...
          {!!student && (
            <>
              ...
              <p className="italic text-neutral-500 mb-4">โดย {student.firstname}</p>
